...
public class WatchaUserWishesPeopleRequestFactory implements WatchaRequestFactory<WatchaBookMetaDto> {
    ...
    private final String HTTP_URL_PATTERN ="https://pedia.watcha.com/api/users/%s/wishes/people";
    ...
    private final static WatchaUserWishesPeopleRequestFactory INSTANCE = new WatchaUserWishesPeopleRequestFactory();

    private WatchaUserWishesPeopleRequestFactory() {}

    public static WatchaUserWishesPeopleRequestFactory getInstance() {
        return INSTANCE;
    }
