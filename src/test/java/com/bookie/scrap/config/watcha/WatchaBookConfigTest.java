...
class WatchaBookConfigTest {
    ...
    public void externalServiceLinkTest() {
        ...
        Assertions.assertEquals("https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=284657330", book.getUrlMap().get(WatchaBookType.EXTERNAL_SERVICE.ALADIN));
        Assertions.assertEquals("https://www.yes24.com/Product/Goods/105526047", book.getUrlMap().get(WatchaBookType.EXTERNAL_SERVICE.YES24));
        Assertions.assertEquals("https://product.kyobobook.co.kr/detail/S000001925800", book.getUrlMap().get(WatchaBookType.EXTERNAL_SERVICE.KYOBO));
