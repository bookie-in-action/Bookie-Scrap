...
public class HttpRequestExecutor {
    ...
    @Value("${bookie.http.retry-limit:3}")
    ...
    public static <T> T execute(Request request) {
...
//        }
    ...
    static class ThreadUtil {
        ...
        private static int threadSleepMs;

        @Value("${bookie.http.thread-sleep:500}")
        private void setThreadSleepMs(int threadSleepMs) {
            ThreadUtil.threadSleepMs = threadSleepMs;
        }
